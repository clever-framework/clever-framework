...
import io.github.toquery.framework.jpa.jpa.AppJpaRepositoryFactoryBean;
...
public @interface EnableAppJpaRepositories {
    /**
     ...
     * @return
     */
    Class<?> repositoryFactoryBeanClass() default AppJpaRepositoryFactoryBean.class;
