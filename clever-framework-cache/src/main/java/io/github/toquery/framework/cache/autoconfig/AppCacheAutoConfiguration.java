...
public class AppCacheAutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(prefix = AppCacheProperties.PREFIX, name = "mode", havingValue = "memory", matchIfMissing = true)
    ...
    @ConditionalOnMissingBean(ICacheService.class)
    @ConditionalOnProperty(prefix = AppCacheProperties.PREFIX, name = "mode", havingValue = "redis")
