insert into sys_menu (id, menu_code, menu_name, menu_level, sort_num, parent_id, parent_ids, tree_path, has_children,
                      create_user_id, create_date_time,
                      update_user_id, update_date_time, deleted)
values (101, 'system', '系统管理', 1, 1, 0, '0', '0,101', true, 1, '2019-06-06 11:11:11', 1, '2019-06-06 11:11:11', false),
       (10101, 'user', '用户管理', 2, 1, 101, '1,101', '0,101,10101', false, 1, '2019-06-06 11:11:11', 1,
        '2019-06-06 11:11:11', false),
       (10102, 'role', '角色管理', 2, 1, 101, '1,101', '0,101,10102', false, 1, '2019-06-06 11:11:11', 1,
        '2019-06-06 11:11:11', false),
       (10103, 'menu', '菜单管理', 2, 1, 101, '1,101', '0,101,10103', false, 1, '2019-06-06 11:11:11', 1,
        '2019-06-06 11:11:11', false),
       (10104, 'log', '日志管理', 2, 1, 101, '1,101', '0,101,10104', false, 1, '2019-06-06 11:11:11', 1,
        '2019-06-06 11:11:11', false),
       (10105, 'config', '配置管理', 2, 1, 101, '1,101', '0,101,10105', false, 1, '2019-06-06 11:11:11', 1,
        '2019-06-06 11:11:11', false);
