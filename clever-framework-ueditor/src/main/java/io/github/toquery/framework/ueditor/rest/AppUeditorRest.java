...
public class AppUeditorRest {
    ...
    public String resquest(@RequestParam(value = "action") String action,
                           @RequestParam(value = "callback", required = false) String callbackName) throws IOException, ServletException {
