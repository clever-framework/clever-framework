package com.toquery.framework.example.bff.api.news.info.model.mapper;
...
public interface BizNewsMapper {
     ...
     * 实体对象转为响应page对象
     *
     * @param bizNewsList 实体对象
     * @return 响应对象
     */
    List<BizNewsPageResponse> bizNews2Page(List<BizNews> bizNewsList);
