package io.github.toquery.framework.security.jwt.interceptor;
 ...
 */
@Slf4j
public class JwtTokenAuthorizationInterceptor implements HandlerInterceptor {

    /**
     * 当前JWT令牌在请求Attribute中的Key
     */
    public static final String JWT_TOKEN_REQUEST_ATTR_KEY = JwtTokenAuthorizationInterceptor.class.getName() + ".JwtToken";
